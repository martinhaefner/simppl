...
struct BrokerClient 
{
   typedef std::multimap<std::string, std::tr1::function<void(std::string, std::string)> > waitersmap_type;
...
private:
   ...
   struct BrokerStub : Stub<Broker>
   {
      ...
      {
         serviceReady >> std::tr1::bind(&BrokerStub::handleServiceReady, this, _1, _2);
      }
      ...
      void handleServiceReady(const std::string& fullName, const std::string& location)
      {
